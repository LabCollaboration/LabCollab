...
export default function SignInAndLoginBtn({setModalShow}) {
  ...
  return (
    <>
      ...
      >
        <span className="block hover:text-hc1 text-tc2 font-semibold text-sm">Sign up</span>
      </button>
      <button
        type="button"
      ...
      >
        <span className="block hover:text-hc1 text-tc2 font-semibold text-sm">Login</span>
      </button>
    </>
  );
}
